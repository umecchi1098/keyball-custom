...
#ifdef OLED_ENABLE
// clang-format off
static const uint8_t PROGMEM cat_0_rle[] = {
    0x16, 0x00, 0x01, 0x80, 0x02, 0x00, 0x02, 0x80, 0x0C, 0x00, 0x05, 0x80, 0x02, 0xC0, 0x05, 0xE0,
    0x01, 0xF0, 0x01, 0xFC, 0x01, 0xFF, 0x01, 0xFD, 0x02, 0xE7, 0x01, 0xFF, 0x01, 0xE7, 0x01, 0x70,
    0x01, 0x30, 0x03, 0x00, 0x05, 0x06, 0x02, 0x03, 0x02, 0x01, 0x01, 0x00, 0x01, 0x01, 0x01, 0x7F,
    0x02, 0xFF, 0x01, 0x3F, 0x01, 0x7F, 0x01, 0xFF, 0x01, 0xDF, 0x03, 0x0F, 0x01, 0x7F, 0x01, 0x3F,
    0x01, 0x1F, 0x01, 0x03, 0x14, 0x00, 0x01, 0x01, 0x01, 0x03, 0x11, 0x00,
};

static const uint8_t PROGMEM cat_1_rle[] = {
    0x18, 0x00, 0x02, 0xC0, 0x01, 0x80, 0x02, 0xC0, 0x04, 0x00, 0x01, 0x80, 0x03, 0xC0, 0x06, 0x60,
    0x01, 0xE0, 0x01, 0xC0, 0x02, 0xE0, 0x06, 0xF0, 0x01, 0xF8, 0x01, 0xFC, 0x01, 0xFF, 0x01, 0xFE,
    0x01, 0xFF, 0x01, 0xF3, 0x01, 0xFF, 0x01, 0x7F, 0x01, 0x32, 0x01, 0x1C, 0x07, 0x00, 0x01, 0x30,
    0x01, 0x38, 0x01, 0x1C, 0x01, 0xDE, 0x01, 0xFE, 0x01, 0x7F, 0x01, 0x3F, 0x01, 0x1F, 0x02, 0x0F,
    0x06, 0x07, 0x03, 0x03, 0x02, 0x07, 0x02, 0x0F, 0x01, 0x06, 0x01, 0x04, 0x21, 0x00,
};

static const uint8_t PROGMEM cat_2_rle[] = {
    0x22, 0x00, 0x01, 0x04, 0x01, 0x0C, 0x05, 0x06, 0x01, 0x0C, 0x01, 0x8C, 0x01, 0x9C, 0x01, 0xF8,
    0x07, 0xF0, 0x03, 0xE0, 0x01, 0xF0, 0x01, 0xFC, 0x01, 0xFE, 0x01, 0xFB, 0x01, 0xCE, 0x01, 0xFE,
    0x01, 0xFF, 0x01, 0xCB, 0x01, 0x60, 0x06, 0x00, 0x01, 0x08, 0x01, 0x0C, 0x01, 0x0E, 0x01, 0x0F,
    0x01, 0x27, 0x02, 0x3F, 0x01, 0x1F, 0x01, 0x0F, 0x09, 0x07, 0x02, 0x0F, 0x01, 0x1F, 0x02, 0x3F,
    0x01, 0x3E, 0x02, 0x04, 0x20, 0x00,
};

static const uint8_t PROGMEM cat_3_rle[] = {
    0x24, 0x00, 0x05, 0x03, 0x01, 0x02, 0x01, 0x06, 0x01, 0x0C, 0x01, 0xDC, 0x01, 0xF8, 0x01, 0xE0,
    0x02, 0xF0, 0x02, 0xE0, 0x01, 0xC0, 0x03, 0x80, 0x01, 0xC0, 0x01, 0xE0, 0x01, 0xF0, 0x01, 0x68,
    0x01, 0x7C, 0x01, 0xF0, 0x01, 0xF8, 0x01, 0x78, 0x0C, 0x00, 0x01, 0x1F, 0x02, 0xFF, 0x01, 0x1F,
    0x04, 0x0F, 0x03, 0x1F, 0x01, 0x7F, 0x03, 0xFF, 0x02, 0x7F, 0x01, 0x67, 0x01, 0x66, 0x01, 0x06,
    0x01, 0x01, 0x18, 0x00, 0x01, 0x01, 0x02, 0x03, 0x05, 0x00,
};

static const uint8_t PROGMEM cat_4_rle[] = {
    0x21, 0x00, 0x02, 0xC0, 0x04, 0x80, 0x02, 0xC0, 0x03, 0xE0, 0x06, 0xF0, 0x02, 0xE0, 0x01, 0xF0,
    0x01, 0xF8, 0x01, 0xFC, 0x01, 0xF6, 0x01, 0x9E, 0x01, 0xFC, 0x01, 0xFE, 0x01, 0xBE, 0x01, 0xC0,
    0x05, 0x00, 0x05, 0x01, 0x04, 0x00, 0x01, 0x03, 0x01, 0x07, 0x03, 0x3F, 0x02, 0xFF, 0x01, 0x7F,
    0x01, 0x3F, 0x03, 0xFF, 0x01, 0x07, 0x03, 0x03, 0x01, 0x01, 0x19, 0x00, 0x01, 0x01, 0x01, 0x03,
    0x09, 0x00,
};
// clang-format on

#    define KEYBALL_CAT_FRAME_BYTES 128
static uint8_t cat_frame_buffer[KEYBALL_CAT_FRAME_BYTES];

static void keyball_oled_write_cat_rle(const uint8_t *rle_data, uint16_t rle_len) {
    // シンプルなRLEを展開してOLEDへ送る
    uint16_t out_index = 0;
    for (uint16_t i = 0; i + 1 < rle_len && out_index < KEYBALL_CAT_FRAME_BYTES; i += 2) {
        uint8_t repeat = pgm_read_byte(&rle_data[i]);
        uint8_t value  = pgm_read_byte(&rle_data[i + 1]);
        while (repeat-- && out_index < KEYBALL_CAT_FRAME_BYTES) {
            cat_frame_buffer[out_index++] = value;
        }
    }
    while (out_index < KEYBALL_CAT_FRAME_BYTES) {
        cat_frame_buffer[out_index++] = 0;
    }
    oled_write_raw((const char *)cat_frame_buffer, KEYBALL_CAT_FRAME_BYTES);
}
#endif

// keyball公式OLED表示関数_ボール情報
...
void keyball_oled_render_cat(void) {
    ...
    switch (cat_state) {
        case 0:
            keyball_oled_write_cat_rle(cat_0_rle, sizeof(cat_0_rle));
            break;
        case 1:
            keyball_oled_write_cat_rle(cat_1_rle, sizeof(cat_1_rle));
            break;
        case 2:
            keyball_oled_write_cat_rle(cat_2_rle, sizeof(cat_2_rle));
            break;
        case 3:
            keyball_oled_write_cat_rle(cat_3_rle, sizeof(cat_3_rle));
            break;
        case 4:
            keyball_oled_write_cat_rle(cat_4_rle, sizeof(cat_4_rle));
            break;
    }
#endif
}
